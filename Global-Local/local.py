# local variable can get access only in the place where created
# example create var inside the function we can get access outside function

def cal_sum(number):
	# result is local variable created inside the func
...
# print(result) << this way the program will crash
