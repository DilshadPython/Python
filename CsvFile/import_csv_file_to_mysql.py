...
database = MySQLdb.connect(
    host='localhost', user='root', password='admin123', db='csvfile')
...
# assign valuse from each rows
    values = (PROPERTY_REFERENCE, PRICE, BEDROOMS, BATHROOMS,
              HOUSE_NUMBER, ADDRESS, REGION, POSTCODE, PROPERTY_TYPE)
