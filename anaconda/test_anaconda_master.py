"""
Master Unit Test Suite Runner for the Anaconda Module.

Executes unit test suites across all 3 pedagogical sub-tiers:
1. 01_fundamentals (conda_basics tests)
2. 02_advanced_environment_management (conda_advanced tests)
3. 03_range_evolution_and_performance (range_conda_performance tests)
...
sys.path.insert(0, str(MODULE_ROOT / "02_advanced_environment_management"))
sys.path.insert(0, str(MODULE_ROOT / "03_range_evolution_and_performance"))


def run_all_anaconda_tests() -> unittest.TestResult:
    """
    Discovers and executes all unit tests within the anaconda module directory.
    ...
    tier2 = loader.discover(str(MODULE_ROOT / "02_advanced_environment_management"), pattern="test_*.py")
