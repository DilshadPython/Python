...
def insert_data():
	cor.execute("INSERT INTO Car VALUES('Audi', 'A5', 2017, 'Brand new zero miles')")
	cor.execute("INSERT INTO Car VALUES('Audi', 'A3', 2015, 'Used 160 000 miles')")
	cor.execute("INSERT INTO Car VALUES('Audi', 'A7', 2016, 'New 35 000 miles')")
	cor.execute("INSERT INTO Car VALUES('Audi', 'A2', 2005, 'Used 61 233 miles')")
	cor.execute("INSERT INTO Car VALUES('BMW', 'XZ', 2010, 'Brand new zero miles')")
	cor.execute("INSERT INTO Car VALUES('Porsche', 'P10', 2014, 'New been used 10 000 miles')")
	cor.execute("INSERT INTO Car VALUES('Mercedes', 'ML', 2017, 'Brand new 1000 miles')")
	cor.execute("INSERT INTO Car VALUES('Ford', 'F16', 2018, 'Newe test only 15 000 miles')")
...
def read_from_after_update():
	# we will tell to display only 2 rows no more
					#after set is the update after where is the original
	sql = "UPDATE Car SET Name = 'a-Audi' WHERE Name = 'Audi' "  

	cor.execute(sql)

	sql = "SELECT * FROM Car"

	for row in cor.execute(sql):
		print(row)

read_from_after_update()
