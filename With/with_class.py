"""
What is happening here is create a class and use with to create 
instance object first create object and run the __eneter__ method
display the msg second the obj send the message run the text_msg()
