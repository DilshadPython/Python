"""Legacy Add Sub Func Script (Refactored).

This module updates the original `add_sub_func.py` script into a PEP 8-compliant,
...
if __name__ == "__main__":
    print("=== Legacy Add Sub Func (Refactored) ===")
