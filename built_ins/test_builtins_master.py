"""
Master Unit Test Suite Runner for the Built-in Functions (built_ins) Module.

Executes unit test suites across all 3 pedagogical sub-tiers:
1. 01_fundamentals (builtin_functions_basics tests)
2. 02_advanced_reflection_and_namespaces (advanced_reflection_and_namespaces tests)
3. 03_range_evolution_and_performance (range_builtin_performance tests)
...
sys.path.insert(0, str(MODULE_ROOT / "02_advanced_reflection_and_namespaces"))
sys.path.insert(0, str(MODULE_ROOT / "03_range_evolution_and_performance"))


def run_all_builtins_tests() -> unittest.TestResult:
    """
    Discovers and executes all unit tests within the built_ins module directory.
    ...
    tier2 = loader.discover(str(MODULE_ROOT / "02_advanced_reflection_and_namespaces"), pattern="test_*.py")
